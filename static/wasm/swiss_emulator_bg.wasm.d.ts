...
export const emulator_add_breakpoint: (a: number, b: number, c: number) => void;
export const emulator_clear_audio_samples: (a: number) => void;
export const emulator_clear_breakpoints: (a: number) => void;
export const emulator_frame_rate: (a: number) => number;
...
export const emulator_get_nametables: (a: number) => number;
export const emulator_get_nametables_len: (a: number) => number;
export const emulator_get_oam_data: (a: number) => number;
export const emulator_get_oam_data_len: (a: number) => number;
export const emulator_get_palettes: (a: number) => number;
export const emulator_get_palettes_len: (a: number) => number;
export const emulator_get_pattern_tables: (a: number) => number;
export const emulator_get_pattern_tables_len: (a: number) => number;
...
export const emulator_step: (a: number) => [number, number, number];
export const emulator_trace_instruction: (a: number) => [number, number, number];
export const emulator_update_nametables: (a: number) => void;
export const emulator_update_palettes: (a: number) => void;
export const emulator_update_pattern_tables: (a: number) => void;
